...
## ContextForce
<Card title="ContextForce" img="/images/llm/lexi-llm-contextforce.jpg">
...
## OpenAI
<Card title="OpenAI" img="/images/llm/lexi-llm-openai.jpg">
  Go to OpenAI to get your API key (Link: https://platform.openai.com)
</Card>

### Obtain OpenAI API Key
<img src="/images/llm/lexi-llm-openai-apikey.jpg" alt="OpenAI API Key"/>

## Gemini
<Card title="Gemini" img="/images/llm/lexi-llm-gemini.jpg">
  Go to Gemini to get your API key. (Link: https://aistudio.google.com/)
</Card>

### Obtain Gemini API Key
<img src="/images/llm/lexi-llm-gemini-apikey.jpg" alt="Gemini API Key"/>

## OpenAI Compatible
<Card title="OpenAI Compatible API" img="/images/llm/lexi-llm-openai-compatible.jpg">
...
<Card img="/images/llm/lexi-llm-local.jpg">
</Card>
