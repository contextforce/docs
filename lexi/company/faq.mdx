...
Absolutely! You can use Lexi for free. Lexi offers free coins per day for to fill up user buckets. And each type of users has different bucket limits.
...
* Bronze coin: This coin is reset every month. You can use these tokens thru free and monthly subscription.
